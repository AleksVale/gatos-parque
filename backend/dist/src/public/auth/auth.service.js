...
let AuthService = class AuthService {
    ...
    async authenticate(authenticateBody) {
        const user = await this.userService.findByEmail(authenticateBody.email);
        const isValidPassword = await bcrypt.compare(authenticateBody.password, user?.password ?? '');
    ...
    async createSupporter(createSupporterBody) {
